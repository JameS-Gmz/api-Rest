...
app.get("/product/:identifier", async (req: Request, res: Response) => {
...
app.get("/product/id/:id", async (req: Request, res: Response) => {
...
app.get("/product/name/:name", async (req: Request, res: Response) => {
...
app.get("/products/stock/:min", async (req: Request, res: Response) => {
...
app.get("/products/price/:min/:max", async (req: Request, res: Response) => {
    const min = req.params.min;
...
app.delete("/products/:text", async (req: Request, res: Response) => {
...
app.delete("/product/delete/:name", async (req: Request, res: Response) => {
...
app.get("/product/stock/:id", async (req: Request, res: Response) => {
